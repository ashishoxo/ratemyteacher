    ...
    <ul class="nav">
        ...
        <li class="nav-item">
            ...
            <div class="collapse" id="ui-advanced">
                <ul class="nav flex-column sub-menu">
                    <li class="nav-item">
                        <a class="nav-link" href="{{route('lectures.list')}}">Lectures</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{route('guestlectures.list')}}">Guest Lectures</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{route('workshops.list')}}">Workshops</a>
                    </li>
                </ul>
            </div>
        </li>
        <li class="nav-item">
            <a class="nav-link" href="{{route('my.teachers')}}"> <img class="menu-icon" src="{{asset('assets/images/menu_icons/01.png')}}" alt="menu icon"> <span class="menu-title">My Teachers</span></a>
        </li>
        <li class="nav-item">
